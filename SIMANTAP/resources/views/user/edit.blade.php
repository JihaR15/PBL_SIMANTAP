        ...
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content border-0" style="border-radius: 15px; overflow: hidden;">
                <div class="modal-header text-white bg-light">
                    <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                            <i class="fas fa-user-edit text-dark fa-2x me-2"></i>
                        </div>
                        <div class="flex-grow-1">
                            <h5 class="modal-title mb-0">Edit Profil Pengguna</h5>
                            <p class="mb-0 small opacity-75 text-muted">Perbarui informasi pengguna</p>
                        </div>
                    </div>
                    <button type="button" class="btn-close btn-close-black" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-8">
                            <div class="pe-lg-4">
                                ...
                                <div class="mb-4" id="jenis-teknisi-container" @if($user->role_id != 6) hidden @endif>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="jenis_teknisi_id" id="jenis_teknisi_id" class="form-select" style="border-radius: 0 10px 10px 0;">
                                            @foreach($jenis_teknisi as $jt)
                                                <option value="{{ $jt->jenis_teknisi_id }}" {{ (isset($user->teknisi) && $user->teknisi->jenis_teknisi_id == $jt->jenis_teknisi_id) ? 'selected' : '' }}>
