...
@else
<form action="{{ url('/jenisteknisi/' . $jenisteknisi->jenis_teknisi_id.'/delete') }}" method="POST" id="form-delete">
    @csrf
    @method('DELETE')
                ...
                <div class="d-flex align-items-center w-100">
                    <div class="flex-grow-1">
                        <h5 class="modal-title mb-0 text-dark">
                            <i class="fas fa-trash-alt me-2"></i>Hapus Data Jenis Teknisi
                        </h5>
                    ...
                    <div class="card-body p-3 bg-light" style="border-radius: 12px;">
                        <table class="table table-borderless table-sm mb-0">
                            <tr>
                                ...
                                <td style="width: 120px; padding: 0.5rem; vertical-align: middle;" class="text-muted small">ID Jenis Teknisi</td>
                                <td style="padding: 0.5rem; vertical-align: middle;" class="fw-bold">
                                    <span class="badge bg-primary bg-opacity-10 text-primary">{{ $jenisteknisi->jenis_teknisi_id }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 40px; padding: 0.5rem; vertical-align: middle; text-align: center;" class="text-primary">
                                ...
                                <td style="width: 120px; padding: 0.5rem; vertical-align: middle;" class="text-muted small">Nama Jenis Teknisi</td>
                                <td style="padding: 0.5rem; vertical-align: middle;" class="fw-bold">
                                    {{ $jenisteknisi->nama_jenis_teknisi }}
                                </td>
                            </tr>
                        </table>
                    </div>
