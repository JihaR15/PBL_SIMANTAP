        ...
        <div class="modal-content border-0" style="border-radius: 15px; overflow: hidden; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.15);">
            ...
            <div class="modal-body p-4">
                ...
                <div class="text-center mt-3">
                    <a href="{{ url('/jenisbarang') }}" class="btn btn-warning rounded-pill px-4 shadow-sm">
...
@else
    <form action="{{ url('/jenisbarang/' . $jenisbarang->jenis_barang_id . '/update') }}" method="POST" id="form-edit" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                ...
                <div class="modal-header bg-light">
                    <div class="d-flex align-items-center w-100">
                        <div class="flex-grow-1">
                            ...
                            <p class="mb-0 small opacity-85 mt-1 text-muted">Memperbarui data jenis barang</p>
                        </div>
                        <button type="button" class="btn-close btn-close-dark" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                </div>
                ...
                <div class="modal-body p-4">
                    <div class="form-group mb-4">
                        ...
                        <div class="d-flex justify-content-between mt-1">
                            ...
                            {{-- <small class="text-muted text-end"><span id="char-count">{{ strlen($jenisbarang->nama_barang) }}</span>/50 karakter</small> --}}
                        </div>
                    </div>
                </div>
