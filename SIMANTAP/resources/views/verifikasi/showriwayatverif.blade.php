@php
    ...
    $isDiverifikasi = ($statusVerif === 'diverifikasi');
    $isBelumDiverifikasi = ($statusVerif === 'belum diverifikasi');

    $verifikasiClass = 'bg-secondary bg-opacity-10 text-secondary';
    $verifikasiIcon = 'ri-time-line';
    $verifikasiText = 'Belum Diverifikasi';

    if ($isDiverifikasi) {
        $verifikasiClass = 'bg-success bg-opacity-10 text-success';
        $verifikasiIcon = 'ri-check-line';
        $verifikasiText = 'Diverifikasi';
    } elseif ($isDitolak) {
        $verifikasiClass = 'bg-danger bg-opacity-10 text-danger';
        $verifikasiIcon = 'ri-close-line';
        $verifikasiText = 'Ditolak';
    } elseif ($isBelumDiverifikasi) {
        $verifikasiClass = 'bg-warning bg-opacity-10 text-warning';
        $verifikasiIcon = 'ri-time-line';
        $verifikasiText = 'Belum Diverifikasi';
    }
    ...
    $urgensi = $laporan->prioritas->klasifikasi_urgensi ?? '-';
        ...
        <div class="modal-content border-0" style="overflow: hidden; border-radius: 12px;">
            ...
            <div class="modal-body p-4">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div>
                        <span class="badge {{ $verifikasiClass }} rounded-pill py-2 px-3">
                            <i class="{{ $verifikasiIcon }} me-1"></i>
                            {{ $verifikasiText }}
                        </span>
                    </div>
                </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-bold">{{ $laporan->perbaikan->selesai_pada ? \Carbon\Carbon::parse($laporan->perbaikan->selesai_pada)->format('d M Y, H:i') : '-' }}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0 fw-bold">{{ $laporan->perbaikan->biaya ? 'Rp ' . number_format($laporan->perbaikan->biaya, 0, ',', '.') : '-' }}</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            @if ($laporan->foto_laporan)
                                                <a href="{{ asset('storage/' . $laporan->foto_laporan) }}" data-lightbox="laporan" data-title="Foto Laporan">
                                                    <div class="image-wrapper position-relative">
                                                        <img src="{{ asset('storage/' . $laporan->foto_laporan) }}" class="img-fluid rounded shadow-sm" style="height: 200px; width: 100%; object-fit: cover;">
                                        ...
                                        <div class="h-100">
                                            ...
                                            @if ($laporan->perbaikan && $laporan->perbaikan->foto_perbaikan)
                                                <a href="{{ asset('storage/' . $laporan->perbaikan->foto_perbaikan) }}" data-lightbox="perbaikan" data-title="Foto Perbaikan">
                                                    <div class="image-wrapper position-relative">
                                                        <img src="{{ asset('storage/' . $laporan->perbaikan->foto_perbaikan) }}" class="img-fluid rounded shadow-sm" style="height: 200px; width: 100%; object-fit: cover;">
                                                        <div class="image-overlay">
                                                            <i class="ri-zoom-in-line text-white"></i>
                                                        </div>
                                                    </div>
        ...
        <div class="modal-content border-0" style="overflow: hidden; border-radius: 12px;">
            ...
            <div class="modal-body p-4">
                ...
                <div class="row align-items-stretch g-4">
                    <div class="{{ $laporan->foto_laporan ? 'col-lg-8' : 'col-lg-12' }} d-flex flex-column">
                                    ...
                                    {{-- <div class="col-md-6 mb-3">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div>
                                                ...
                                                <p class="mb-0 fw-bold">{{ $laporan->pelapor->name ?? '-' }}</p>
                                            </div>
                                        </div>
                                    </div> --}}
                                </div>
