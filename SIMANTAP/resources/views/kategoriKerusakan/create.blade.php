                ...
                <div class="d-flex align-items-center w-100">
                    <div class="flex-grow-1">
                        <h5 class="modal-title mb-0 text-dark">
                            <i class="fas fa-plus-circle me-2"></i>Tambah Data Kategori Kerusakan
                        </h5>
                        <p class="mb-0 small opacity-85 mt-1 text-muted">Formulir penambahan kategori baru</p>
                    </div>
            ...
            <div class="modal-body p-4">
                <div class="form-group mb-4">
                    ...
                    <div class="d-flex justify-content-between mt-1">
                        ...
                        {{-- <small class="text-muted text-end"><span id="char-count">0</span>/100 karakter</small> --}}
                    </div>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        $('#nama_kategori').on('input', function() {
            ...
            if (currentLength > 100) {
                ...
                $('#error-nama-kategori').text('Maksimal 100 karakter');
            } else {
