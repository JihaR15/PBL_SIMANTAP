            ...
            <div class="modal-header text-white bg-light">
                <div class="d-flex align-items-center w-100">
                    <div class="flex-grow-1">
                        ...
                        <p class="mb-0 small opacity-85 mt-1 text-muted">Formulir penambahan unit baru</p>
                    </div>
            ...
            <div class="modal-body p-4">
                <div class="form-group mb-4">
                    ...
                    <div class="input-group">
                        ...
                        @if($fasumExist)
                            <input type="text" class="form-control rounded-end" value="Fasilitas Gedung" readonly>
                            <input type="hidden" name="fasilitas_id" value="1">
                        @else
                            <select id="fasilitas_id" class="form-select rounded-end" name="fasilitas_id" required>
