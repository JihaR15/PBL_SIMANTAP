            ...
            <div class="modal-header text-white bg-light">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1">
                        <h5 class="modal-title mb-0">Tambah Data Pengguna</h5>
                        <p class="mb-0 small opacity-75 text-muted">Tambahkan pengguna baru ke sistem</p>
                    </div>
                </div>
                        ...
                        <div class="pe-lg-4">
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="role_id" id="role_id2" class="form-select" style="border-radius: 0 10px 10px 0;" required>
                                        @foreach($role as $l)
                            ...
                            <div class="mb-4" id="jenis-teknisi-container" hidden>
                                <label class="form-label fw-semibold">Jenis Teknisi</label>
                                <div class="input-group">
                                    <span class="input-group-text bg-light" style="border-radius: 10px 0 0 10px;">
                                        <i class="fas fa-tools text-primary"></i>
                                    </span>
                                    <select name="jenis_teknisi_id" id="jenis_teknisi_id" class="form-select" style="border-radius: 0 10px 10px 0;">
                                        <option value="">Pilih Jenis Teknisi</option>
                                        @foreach($jenis_teknisi as $jt)
                                            <option value="{{ $jt->jenis_teknisi_id }}">{{ $jt->nama_jenis_teknisi }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="username" id="username" class="form-control" style="border-radius: 0 10px 10px 0;" required>
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" style="border-radius: 0 10px 10px 0;" required>
                                </div>
                            ...
                            <div class="mb-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" name="password" id="password" class="form-control" style="border-radius: 0;" required>
                            ...
                            <div class="d-flex flex-column align-items-center justify-content-center flex-grow-1">
                                <div class="position-relative mb-3">
                                    <label for="foto_profile" class="d-block cursor-pointer position-relative">
                                        <img src="{{ asset('profile_placeholder.png') }}"
                                            alt="Profile Picture"
...
<script>
    $(document).ready(function () {
        ...
        function toggleJenisTeknisi() {
            var selectedRoleId = $('#role_id2').val();
            if (selectedRoleId === teknisiRoleId) {
                ...
                $('#jenis_teknisi_id').prop('required', false).val('');
            }
        }
