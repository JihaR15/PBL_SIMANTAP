    ...
    <div id="modal-master" class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <a href="{{ url('/kategoriKerusakan') }}" class="btn btn-warning">Kembali</a>
            </div>
        </div>
    </div>
@else
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12">
                                    <input type="text" name="nama_kategori" id="nama_kategori" class="form-control" value="{{ $kategoriKerusakan->nama_kategori }}" required>
