                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="col-md-12">
                                    ...
                                    <p class="card-title">Berikut adalah daftar riwayat perbaikan yang sudah Anda kerjakan. Klik tombol "Detail" untuk melihat detail Perbaikan.</p>
                                </div>
                            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#datatable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('perbaikan.riwayatList') }}",
                    type: "POST",
                    headers: {
